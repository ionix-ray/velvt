...
fn IconTwitter() -> Element {
    ...
    rsx!(
        svg { width: "1em", height: "1em", view_box: "0 0 32 32", fill: "currentColor",
...
fn IconFilm() -> Element {
    rsx!(
        svg { width: "1em", height: "1em", view_box: "0 0 32 32", fill: "none", stroke: "currentColor", stroke_width: "1.5",
